...
APP_NAME="freightshark"
REPO_DIR="/home/hakim/freightshark"
RELEASES_DIR="/var/www/releases-freightshark"
DEPLOY_SYMLINK="/var/www/freightshark"
TIMESTAMP=$(date +%s)
...
# update code
git pull origin rebrand-fe || { echo "❌ Failed to git pull"; exit 1; }
