...
export default function ShipmentCard({ title, description, buttonText, imageType, onClick }) {
  return (
  <div className="flex flex-wrap flex-col-reverse lg:flex-row items-start lg:items-center lg:justify-between w-full bg-white rounded-lg border border-gray-200  p-4">
